...
public class ProductDao {
    ...
    public int addProduct(Product product) {
        String sql = "INSERT INTO Product(weight,productName,description,userId) VALUES(?,?,?,?)";
    ...
    public int updateProductById(Product product, int id) {
        String sql = "UPDATE Product SET weight=?, productName=?, description=?, userId=? WHERE productId = ?";
        return jdbcTemplate.update(sql, product.getWeight(), product.getProductName(), product.getDescription(),
